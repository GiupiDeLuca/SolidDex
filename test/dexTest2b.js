...
contract("Dex", accounts => {
    ...
    it("Market orders can be submitted even if the order book is empty", async () => {
        ...
        let orderbook = await dex.getOrders(web3.utils.fromUtf8("LINK"), 0); //Get buy side orderbook
    ...
    it("Market orders should not fill more limit orders than the market order amount", async () => {
        ...
        let orderbook = await dex.getOrders(web3.utils.fromUtf8("LINK"), 1); //Get sell side orderbook
        ...
        orderbook = await dex.getOrders(web3.utils.fromUtf8("LINK"), 1); //Get sell side orderbook
